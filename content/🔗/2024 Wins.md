...
- 1 additional experiment + write-up complete
	- [[6. Next.js PWA application 🟢]]
	- (This fell off the wayside with other items coming up)
...
- Did a hackathon hosted by OpenAI and South Park Commons. We worked on connecting graph notes together. It was mildly stressful working with random people but I learned a lot about new full-stack tools like [Astro](https://docs.astro.build/en/guides/integrations-guide/react/)
...
I spent a lot of time this month catching up with family I'd been neglecting during the startup journey in the last few years. I spent a *lot* of time with my parents in SoCal, celebrated Chinese New Year with my relatives in Los Angeles, and caught up with my cousin in San Francisco. I am always shocked how similar I am to my relatives. Our speech patterns, our cheekbones, our boisterous laughter. Patterns of guilt and shame. Body language of showing affection. Maybe it is surprising to me because I spend so much time away from family, working with people whose cultural and geographical backgrounds are so different from mine. My chest feels warm when I think of family. 
