...
- X additional experiments 
	- [[what's it like having a translation that is not only between natural languages? (just an experiment /translate)]]
	- Proposals
		- [[Back-translation for Language Model Outputs]]
		- [[Knowledge base scaffolding for humans and computers]]
		- Evals
## February
...
- 1 additional experiment + write-up and a few proposal drafts
	...
	- Proposals
		- [[Multicomponent Systems that Self-Organize with an Information Stream]]
		- [[Universal Task Graph for Traversing the Web with Continuously Running Tests]]
